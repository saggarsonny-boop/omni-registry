...
const converter_1 = require("../src/lib/converter");
// ANSI Colors
const RESET = "\x1b[0m";
const BOLD = "\x1b[1m";
const GREEN = "\x1b[32m";
...
function assertGlitch(condition, message) {
    glitchTestCount++;
    if (condition) {
        glitchPassCount++;
...
try {
    const r1 = (0, converter_1.convertCode)("");
...
try {
    ...
    const r1 = (0, converter_1.convertCode)(sqlInjectionInput);
    ...
    const r2 = (0, converter_1.convertCode)(xssInput);
    ...
    const r3 = (0, converter_1.convertCode)(pathTraversalInput);
...
try {
    ...
    const r1 = (0, converter_1.convertCode)(hugeString);
...
try {
    ...
    const r1 = (0, converter_1.convertCode)(emojiInput);
    ...
    const r2 = (0, converter_1.convertCode)(mixedAccents);
...
try {
    ...
    const r1 = (0, converter_1.convertCode)(missingBracket);
    ...
    const r2 = (0, converter_1.convertCode)(nestedBrackets);
    ...
    const r3 = (0, converter_1.convertCode)(invertedBrackets);
